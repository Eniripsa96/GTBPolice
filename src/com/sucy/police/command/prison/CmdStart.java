...
/**
 * Command to set the starting point for prisons
 */
public class CmdStart implements ICommand {
    ...
    public void execute(CommandHandler handler, Plugin plugin, CommandSender sender, String[] args) {
        ...
        if (sender instanceof Player) {
            ...
            police.setPrisonLoc(((Player) sender).getLocation());
            sender.sendMessage(ChatColor.DARK_GREEN + "The prison starting location has been set to your location");
        }
